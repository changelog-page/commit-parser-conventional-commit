...
use Changelog\CommitParser\ConventionalCommit\Parser;

it('parses messages with a scope', function (string $type) {
    $actual = (new Parser())->parse("$type(scope)!: this is my long commit message #123");
...
it('parses messages without a scope', function (string $type) {
    $actual = (new Parser())->parse("$type: this is my long commit message #123");
...
it('parses messages without a ticket', function (string $type) {
    $actual = (new Parser())->parse("$type: this is my long commit message");
